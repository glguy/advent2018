...
opcodes =
  let sem f a b c regs = IntMap.insert c (f (regs !) a b) regs
      val o = o in
  Map.fromList
...
part2 examples program = finalRegs ! 0 -- read final register 0
  where
...
--
-- >>> getConstraints [E (toRegisters [3,2,1,1]) (I 9 2 1 2) (toRegisters [3,2,2,1])]
